...
export const StudioRentalPage: React.FC<BookingProps> = ({ onBook }) => {
  ...
  return (
    <div className="w-full flex flex-col items-center">
            ...
            <div className="mb-20">
              <div className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-8">
                {durationOptions.map((opt, i) => (
                  <button 
                    key={opt.hours}
                    onClick={() => onBook(`${opt.hours} Hour Booking`)}
            ...
            {[
              ...
              <Reveal key={i} delay={0.1 * i} className="h-full">
                <div className="flex flex-col justify-between h-full p-8 border border-charcoal/10 bg-cream hover:bg-white hover:border-charcoal/30 transition-all duration-300 group">
                  ...
                  <Button variant="outline" className="w-full text-xs py-3" onClick={() => onBook(card.title)}>
                    Book This Option
                  </Button>
                </div>
              </Reveal>
          ...
          {[
            ...
            <Reveal key={i} delay={0.05 * i}>
              <div className="flex flex-col items-center text-center space-y-3">
                <div className="w-12 h-12 rounded-full bg-beige flex items-center justify-center text-charcoal mb-2">
                  {item.icon}
                </div>
      ...
      {/* S4: Testimonials (Google Reviews) */}
      ...
      {/* S6: Step-by-Step */}
      <section className="w-full px-6 md:px-12 lg:px-24 py-24 bg-beige/20">
