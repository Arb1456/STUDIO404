...
import { VoiceAgentBlock } from './components/VoiceAgentBlock';
import { VoiceAgentModal } from './components/VoiceAgentModal';
import { InquiryTemplate, BookingType } from './types';
...
const ContactPage: React.FC<ContactPageProps> = ({ onBook }) => {
  ...
  // Handle auto-scroll to form when a template is clicked
