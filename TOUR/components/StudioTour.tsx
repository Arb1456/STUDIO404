...
export const StudioTour: React.FC<SectionProps> = ({ onBook }) => {
  ...
  return (
    <div className="h-screen w-full overflow-y-scroll snap-y snap-mandatory scroll-smooth no-scrollbar">
      ...
      <SnapSection className="bg-cream relative">
        {/* Mobile Background: Absolute image with overlay, hidden on desktop */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 h-full w-full relative z-10">
            ...
            {/* Text Column: Full width on mobile, right side on desktop */}
      ...
      {/* 8. Changeroom (re-numbered) */}
      <SnapSection className="bg-[#262626] text-cream">
