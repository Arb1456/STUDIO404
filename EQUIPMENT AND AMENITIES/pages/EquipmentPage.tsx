...
const EquipmentPage: React.FC<Pick<NavProps, 'onBook'>> = ({ onBook }) => {
      ...
      content: (
        <div className="space-y-8">
           <div className="max-w-2xl mx-auto">
              ...
              <h3 className="text-xl font-serif mb-4 border-b border-[#262626]/10 pb-2">Inventory List</h3>
        ...
        <div className="space-y-8">
            <div className="max-w-2xl mx-auto">
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li>12+ Umbrellas in Varying Sizes (Shoot through, Reflective, with Diffusion, etc)</li>
              </ul>
           </div>
        </div>
      )
         ...
         <div className="space-y-8">
            <div className="max-w-2xl mx-auto">
              ...
              <ul className="space-y-3 text-sm">
                 ...
                 <li>1x 5-in-1 Reflector Kit (White, Gold, Silver, Black, Diffusion)</li>
         ...
         <div className="space-y-8">
            <div className="max-w-2xl mx-auto">
              ...
              <ul className="space-y-3 text-sm">
                 ...
                 <li>Mini Clamps</li>
                 <li>Tapes (Gaffing Tape, Electrical Tape)</li>
                 <li>Ladders</li>
                 <li>Fishing Wire</li>
              </ul>
            </div>
  ...
  // Mappable Data for Galleries - Updated to 6 items
    ...
    <div className="pb-32 min-h-screen">
      ...
      <AnimatePresence>
        {activeModal && (
          <motion.div 
            ...
            className="fixed inset-0 z-[60] bg-[#F2EFE9] overflow-y-auto"
          >
             <div className="sticky top-0 right-0 p-6 flex justify-between items-center bg-[#F2EFE9]/90 backdrop-blur-md z-10 border-b border-[#262626]/10">
                <span className="text-2xl font-serif italic">{activeModal.title}</span>
                <button 
                  onClick={() => setActiveModal(null)}
                  className="p-2 rounded-full hover:bg-[#262626]/5 transition-colors"
                >
                  <X size={32} />
                </button>
             </div>
      ...
      <section className="relative min-h-[60vh] md:h-[80vh] flex items-center md:items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
            ...
            />
            <div className="absolute inset-0 bg-[#F2EFE9]/40 mix-blend-overlay"></div>
        </div>
        
        <div className="relative z-10 text-left px-6 max-w-7xl mx-auto w-full py-20">
          <Reveal>
            <h1 className="text-4xl sm:text-6xl md:text-8xl mb-6 md:mb-8 leading-tight max-w-4xl">
              Everything You <br/> Need to <span className="italic-serif">Create</span>.
            </h1>
          </Reveal>
          <Reveal delay={0.2}>
      ...
      {/* 2. Navigation Grid - Glowing Circles (3 top, 2 bottom) */}
            ...
            <div className="flex flex-wrap justify-center gap-6 md:gap-10 w-full">
              {gridItems.slice(0, 3).map((item, index) => (
                <button
                  ...
                  className="group relative w-28 h-28 md:w-40 md:h-40 rounded-full bg-[#262626] text-[#F2EFE9] border border-white/40 shadow-[0_0_15px_rgba(0,0,0,0.2)] hover:shadow-[0_0_25px_rgba(0,0,0,0.3)] transition-all duration-500 ease-out flex flex-col items-center justify-center gap-3 hover:scale-105 z-10 p-4"
                >
      ...
      {/* 3. Lighting Grid - 3 Square Blocks */}
      <section id="lighting" className="py-24 px-6 border-t border-[#262626]/10">
        <div className="max-w-7xl mx-auto">
          <Reveal>
            <div className="mb-16">
              <h2 className="text-5xl md:text-6xl mb-6">Precision <span className="italic-serif">Lighting</span></h2>
          ...
          <Reveal delay={0.2}>
             <div className="grid grid-cols-3 gap-2 md:gap-8">
                ...
                <button 
                    ...
                    className="group relative w-full aspect-square bg-[#262626] text-[#F2EFE9] border border-white/40 shadow-[0_0_15px_rgba(0,0,0,0.2)] hover:shadow-[0_0_25px_rgba(0,0,0,0.3)] transition-all duration-300 flex flex-col items-center justify-center p-4"
                >
      ...
      {/* 4. Grip & Support - 3 Square Blocks (Functionality Match) */}
      <section id="grip" className="py-24 px-6 bg-[#F2EFE9] text-[#262626]">
        <div className="max-w-7xl mx-auto">
          <Reveal>
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-[#262626]/20 pb-8">
              <h2 className="text-5xl md:text-6xl">Grip & <span className="italic-serif">Support</span></h2>
          ...
          <Reveal delay={0.2}>
             <div className="grid grid-cols-3 gap-2 md:gap-8">
                ...
                <button 
                    ...
                    className="group relative w-full aspect-square border border-[#262626]/10 bg-[#262626] text-[#F2EFE9] hover:bg-white hover:text-[#262626] transition-colors duration-300 flex flex-col items-center justify-center p-4"
                >
                    <span className="text-[10px] md:text-lg uppercase tracking-widest text-center">Stands</span>
                </button>
                
                {/* Reflectors & Coloring Block (Updated from Flags) */}
                <button 
      ...
      <section id="seamless" className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <Reveal>
              <h2 className="text-5xl mb-8">The <span className="italic-serif">Paper</span> Library</h2>
              <p className="mb-4 opacity-80">
                A constantly rotated selection of Savage Universal paper backgrounds. All rolls are 107 inches wide, offering ample space for full-body portraits and commercial sets.
              </p>
      ...
      <section id="amenities" className="py-24 px-6 bg-white/50">
        <div className="max-w-7xl mx-auto">
          <Reveal>
            <h2 className="text-5xl text-center mb-16">Designed for <span className="italic-serif">Comfort</span></h2>
          </Reveal>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Reveal>
              <Accordion title="Client Lounge">
                  <div className="space-y-4 pt-4">
                    ...
                    Clients have plenty of options. An assortment of furniture is laid out in different areas of the studio where they can lounge, collaborate, discuss plans, or simply chill while they're waiting for portions of their project to wrap up.
                    </p>
            ...
            <Reveal delay={0.2}>
              <Accordion title="Private Change Room">
                   <div className="space-y-4 pt-4">
                    <p className="opacity-70 leading-relaxed text-sm">
                    There is a private change room/hair and makeup area that's well lit, spacious, and allows the client the freedom to prepare for their project properly.
                    </p>
      ...
      {/* 7. Props & Furniture - Mapped Photos */}
      <section id="props" className="py-24 px-6 max-w-7xl mx-auto">
         <Reveal>
            <div className="text-center mb-16">
                 <h2 className="text-5xl mb-6">Props & <span className="italic-serif">Furniture</span></h2>
      ...
      {/* 8. Final CTA */}
      <section className="py-32 px-6 text-center border-t border-[#262626]/10">
        <Reveal>
          <h2 className="text-6xl md:text-8xl mb-12">
            Pro Gear. Pro Space.<br />
            <span className="italic-serif">Ready to Book?</span>
          </h2>
          <Button onClick={() => onBook('rental')}>Book Your Time</Button>
        </Reveal>
      </section>
