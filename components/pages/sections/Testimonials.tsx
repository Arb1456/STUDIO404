...
const Testimonials: React.FC = () => {
    ...
    return (
        <section className="h-screen-safe w-full snap-start scroll-mt-[100px] md:scroll-mt-0 bg-charcoal flex flex-col items-center justify-center pb-nav-safe overflow-hidden">
            {/* Header */}
