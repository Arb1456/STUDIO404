        ...
        <div className="min-h-screen bg-cream text-charcoal pt-24 pb-32">
            ...
            <section className="px-6 md:px-12 py-16 md:py-24 max-w-7xl mx-auto text-center">
                <Reveal width="100%" className="flex flex-col items-center">
                    ...
                    <Button onClick={() => navigate('/tour')} variant="outline">
                        View Studio Tour
                    </Button>
                </Reveal>
            </section>
            ...
            <section className="px-6 md:px-12 py-24 text-center bg-charcoal text-cream">
                <Reveal width="100%" className="flex flex-col items-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                        <Button onClick={() => navigate('/tour')} variant="outline" className="border-cream text-cream hover:bg-cream hover:text-charcoal">
                            View Studio Tour
                        </Button>
                        <Button onClick={() => navigate('/gallery')} variant="primary" className="bg-cream text-charcoal border-cream hover:bg-transparent hover:text-cream">
                            Explore Client Work
                        </Button>
                    </div>
                </Reveal>
